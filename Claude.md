...
This installs the plugin into the shared Conxa runtime (`~/.conxa/`). The runtime exposes a single `conxa` MCP server; all installed plugins are accessible through it.
